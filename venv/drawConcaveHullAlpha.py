...
def saveMiddle( file_path, save_path ):
  ...
  def save_points( ):
    ...
    multipolygonBeta = MultiPolygon(multipolygonSource)
    envelope_polygon = multipolygonBeta.envelope
    center_coordinates = envelope_polygon.centroid.xy
    width = center_coordinates[0][0]/(72/25.4)
    height = center_coordinates[1][0]/(72/25.4)
    with open(save_path, "a" ) as f:
      f.write(f"{width:.2f} {height:.2f}\n")
  save_points()
